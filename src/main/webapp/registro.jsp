            ...
            <footer class="text-white mt-3" style="background-color:#546e7a;">
                ...
                <div class="container">
                    ...
                    <div class="container2">
                        <!--Contacto-->
                        <div class="contacto">
                            <p><i class="email-icon21 email fas fa-envelope-open-text fa-2x" style="padding-right: 12px;"></i>claudiocartagena@cartagenacg.com.co</p>  
                            <p><i class="cell-icon21 cel fas fa-mobile fa-2x" style="padding-right: 20px;"></i>310 403 5424</p>            
                        </div>
